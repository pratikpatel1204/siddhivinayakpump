<div class="nav-header">
    <div class="brand-logo">
        <a href="#">
            <b class="logo-abbr"><img src="{{asset('admin/images/logo.png')}}" alt="" style="width: 15px;"> </b>
            <span class="logo-compact"><img src="{{asset('admin/images/logo-compact.png')}}" alt=""></span>
            <span class="brand-title">
                <img src="{{asset('admin/images/logo-compact.png')}}" alt="" style="width: 100px;">
            </span>
        </a>
    </div>
</div>
            ...
            <ul class="clearfix">
                ...
                <li class="icons dropdown">
                    <div class="user-img c-pointer position-relative" data-toggle="dropdown">
                        ...
                        <img src="{{ asset(auth()->user()->profile_image) }}" height="40" width="40" alt="">
                    </div>
                    <div class="drop-down dropdown-profile animated fadeIn dropdown-menu">
                        <div class="dropdown-content-body">
                            <ul>
                                <li><a href="{{route('show.profile')}}"><i class="icon-user"></i> <span>Profile</span></a></li>
                                <hr class="my-2">
...
<div class="nk-sidebar">
    <div class="nk-nav-scroll">
        <ul class="metismenu" id="menu">           
            <li>
                <a href="{{route('show.dashboard')}}" aria-expanded="false">
