...
<?php $__env->startSection('title', config('app.name') . ' || Reward Redeem'); ?>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select name="service" id="service" class="form-control">
                                            <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($service->service_name); ?>" data-point="<?php echo e($service->price); ?>" 
                                                    <?php echo e($key === 0 ? 'selected' : ''); ?>>
...
<script>
    $(document).ready(function() {
        ...
        $("#searchBtn").on("click", function() {
            ...
            $.ajax({
                url: "<?php echo e(route('redeem.check')); ?>"
                , method: "POST"
                , data: {
...
<script>
    $(document).ready(function() {
        ...
        $("#submitBtn").on("click", function() {
            ...
            $.ajax({
                url: "<?php echo e(route('redeem.update')); ?>"
                , method: "POST"
                , data: formData
                , success: function(response) {
...
<?php echo $__env->make('layout.main-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/siddhivinayakpump.com/public_html/resources/views/redeem/create.blade.php ENDPATH**/ ?>