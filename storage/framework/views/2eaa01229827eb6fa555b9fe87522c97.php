...
<?php $__env->startSection('title', config('app.name') . ' || Customer Report'); ?>
                            ...
                            <div class="row align-items-center g-2">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group mb-0">
                                        <input type="number" name="number" id="number" class="form-control" placeholder="Enter Mobile No" value="<?php echo e(request('number')); ?>">
                                ...
                                <div class="col-md-6 d-flex flex-column flex-md-row align-items-center gap-2">
                                    <div class="form-group mb-0 w-100">
                                        <input type="text" name="rewarddate" id="rewarddate" class="form-control" placeholder="Select Date Range" value="<?php echo e(request('rewarddate')); ?>">
...
<script>
    $(document).ready(function() {
        $('#search').on('click', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('search.customer.report')); ?>", // Replace with your route name
                method: 'POST'
                , data: {
                    number: number
...
<?php echo $__env->make('layout.main-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/siddhivinayakpump.com/public_html/resources/views/report/customer-report.blade.php ENDPATH**/ ?>